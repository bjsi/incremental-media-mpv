...
local keys = {
    ["incmedia-set-extract-boundary"] = function() active.queue:set_extract_boundary() end,
    ["incmedia-menu-toggle"] = function() menu.open() end,
    ["incmedia-adjust-priority"] = function(n) active.queue:adjust_priority(n) end,
    ["incmedia-adjust-interval"] = function(n) active.queue:adjust_interval(n) end,
    ["incmedia-adjust-afactor"] = function(n) active.queue:adjust_afactor(n) end,
    ["incmedia-clear-extract-boundaries"] = function() active.queue:clear_abloop() end,
    ["incmedia-set-end-boundary-extract"] = function() active.queue:set_end_boundary_extract() end,
    ["incmedia-copy-url"] = function() active.queue:copy_url(false) end,
    ["incmedia-copy-url-with-timestamp"] = function() active.queue:copy_url(true) end,
    ...
    ["incmedia-next"] = function() active.queue:next_repetition() end,
