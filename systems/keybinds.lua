...
local keys = {
    ...
    ["im-global-extracts"] ={ cb= function() active.load_global_extracts() end, queue=true},
    ["im-global-items"] ={ cb= function() active.load_global_items() end, queue=true},
    ["im-global-topics"] ={ cb= function() active.load_global_topics() end, queue=true},
