...
function Rep:to_export() return self.row["toexport"] == "1" end
...
function Rep:type() error("override me!") end

function Rep:is_dismissed() return self.row["dismissed"] == "1" end
...
function Rep:valid_stop() return tonumber(self.row["stop"]) ~= nil end

function Rep:valid_start() return tonumber(self.row["start"]) ~= nil end
